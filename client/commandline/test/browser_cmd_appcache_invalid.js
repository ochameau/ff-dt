...
const TEST_URI = "http://sub1.test1.example.com/browser/client/commandline/" +
...
function* spawnTest() {
  let lines = [
    ...
    "The file http://sub1.test1.example.com/browser/client/" +
      "commandline/test/browser_cmd_appcache_invalid_page3.html was modified " +
      "after http://sub1.test1.example.com/browser/client/" +
