...
function test() {
  helpers.addTabWithToolbar(TEST_URI, function (options) {
    return helpers.audit(options, [
      ...
      {
        setup:    "inject http://example.com/browser/client/commandline/test/browser_cmd_inject.js",
        check: {
          input:  "inject http://example.com/browser/client/commandline/test/browser_cmd_inject.js",
