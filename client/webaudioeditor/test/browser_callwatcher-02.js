...
add_task(function* () {
  ...
  is(error.fileName, "http://example.com/browser/client/webaudioeditor/test/doc_bug_1112378.html", "error has correct fileName");
  ...
  is(error.filename, "http://example.com/browser/client/webaudioeditor/test/doc_bug_1112378.html", "exception has correct filename");
