...
# Normalize application folder name, which can be:
# FirefoxNightly.app (branded nightly), Nightly.app (unbranded nightly), Firefox.app (release), FirefoxBeta.app, FirefoxAurora.app
